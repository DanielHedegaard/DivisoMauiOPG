...
namespace CLBL
{
    public static class PasswordHash
    {
        ...
        public static bool ValidatePassword(string password, string correctHash) // Her bliver bruger inputtet(passwordet) samt det korrekte hashede password valideret.
        {
